...
citation_title: II. Identifying Student Resources
lang: en-US
...
theme-color: "\\#ffffff"
title: II. Identifying Student Resources -- Exploring Physical Phenomena
...
-   [Sign
    in](https://open.oregonstate.education/physicsforteachers/wp-login.php?redirect_to=https%3A%2F%2Fopen.oregonstate.education%2Fphysicsforteachers%2Fchapter%2Fidentifying-student-resources%2F)
...
::: {.section .standard .post-32 .chapter .type-chapter .status-publish .hentry .chapter-type-standard data-type="chapter"}
# II. Identifying Student Resources {#ii.-identifying-student-resources .entry-title}
...
### **A. Learning about ways to foster science learning** {#U1H31}

Here is the first question:

##### ***Question 1.1 What have you learned about light at some time in your life, inside or outside of school, during an experience when you enjoyed the learning process?*** {#U1H51 .no-indent style="text-align: center"}
...
#### *1. An example of student work identifying resources for fostering science learning**** *** {#U1H41}
...
about
light.](https://open.oregonstate.education/app/uploads/sites/12/2019/06/Fig-1.1.png){.wp-image-27
...
students.](https://open.oregonstate.education/app/uploads/sites/12/2019/06/Fig-1.2.png){.wp-image-28
...
### **B. Documenting initial ideas about light phenomena** {#U1H32}
...
##### ***Question 1.2 What do you already know about looking at something like a ball?*** {#U1H52 style="text-align: center"}
...
Previous: I.
Introduction](https://open.oregonstate.education/physicsforteachers/chapter/introduction/ "Previous: I. Introduction")
:::

::: {.nav-reading__next .js-nav-next}
[Next: III. Developing Central Ideas Based on Evidence
![](data:image/svg+xml;base64,PHN2ZyBjbGFzcz0iaWNvbi0tc3ZnIj48dXNlIGhyZWY9IiNhcnJvdy1yaWdodCI+PC91c2U+PC9zdmc+){.icon--svg}](https://open.oregonstate.education/physicsforteachers/chapter/developing-powerful-ideas-based-on-evidence-2/ "Next: III. Developing Central Ideas Based on Evidence")
:::
